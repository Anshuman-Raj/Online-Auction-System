...
class CreateAuctionRequest():
    ...
    async def load_data(self):
        ...
        self.start_time = datetime.strptime(str(form.get("start_time")), "%Y-%m-%dT%H:%M")
        self.end_time = datetime.strptime(str(form.get("end_time")), "%Y-%m-%dT%H:%M")
